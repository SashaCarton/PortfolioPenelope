    ...
    <div class="home__text">
        ...
        <div class="text" :class="{ 'skeleton-text': isLoading }">
            <template v-if="!isLoading">
                ...
                <p>Formée aux beaux‑arts pendant 9 ans à l'école des arts plastiques de Lens, j'ai rejoint l'ESAAT de Roubaix et obtenu le BAC STD2A (arts appliqués) en 2024. En parallèle, j'ai travaillé sur de nombreux projets numériques car je suis passionnée par les technologies, le web, les jeux, et les expériences immersives..., Aujourd'hui étudiante en design numérique à l'ENSAAMA (Olivier de Serres) de Paris depuis septembre 2024, je suis à la recherche d'un stage alliant nouvelles technologies, créativité et savoir‑faire.</p>
